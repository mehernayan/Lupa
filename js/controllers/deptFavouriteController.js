lupaApp.controller('deptFavouriteController', ['$scope', 'userData', 'lupaDeptDashboardService', '$location', 'localStorageService', '$interval', function ($scope, userData, lupaDeptDashboardService, $location, localStorageService, $interval) {
